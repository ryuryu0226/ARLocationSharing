...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void ChannelCredentials__cctor_mE13414DE25A46A5C5AD0CBD4220C158258533569 (const RuntimeMethod* method)
{
	...
	}
	{
		...
		SslCredentials_t149917768B7958A3C7B569C5879C5CAFC7F43D3C * L_1 = (SslCredentials_t149917768B7958A3C7B569C5879C5CAFC7F43D3C *)il2cpp_codegen_object_new(SslCredentials_t149917768B7958A3C7B569C5879C5CAFC7F43D3C_il2cpp_TypeInfo_var);
		SslCredentials__ctor_m8B35719C14541011FB9DF867DCEDEB85B8B216D2(L_1, /*hidden argument*/NULL);
		((ChannelCredentials_t0E172BDC82B0B9F87D1648BB35AB04DD3CFB5A1E_StaticFields*)il2cpp_codegen_static_fields_for(ChannelCredentials_t0E172BDC82B0B9F87D1648BB35AB04DD3CFB5A1E_il2cpp_TypeInfo_var))->set_SecureSslInstance_1(L_1);
		return;
	}
}
#ifdef __clang__
...
{
	{
		...
		String_t* L_2 = __this->get_rootCertificates_2();
		KeyCertificatePair_tA0E29F1A2B9C02967DCEF3AEBF14D49AB346592C * L_3 = __this->get_keyCertificatePair_3();
		VerifyPeerCallback_t80B8E9DEB9B025308E05573E757CA8136A52DD9A * L_4 = __this->get_verifyPeerCallback_4();
		NullCheck(L_0);
